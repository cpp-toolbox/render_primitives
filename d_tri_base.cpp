 ...
 */
DTriBase::DTriBase(unsigned int draw_mode, float flattened_vertices[], int num_flattened_vertices, float r, float g,
                   float b) {
    this->shader_pipeline.load_in_shaders_from_file("../graphics/shaders/absolute_position.vert",
