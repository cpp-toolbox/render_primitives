...
//     std::vector<float> vertices; // flattened vertex_positions in row major order
//                                  //    unsigned int *indices;
//     unsigned int num_strips;
//     unsigned int num_indices_per_strip;
//     HeightMap(std::vector<float> data_points, int width, int height);
//     void draw();
//     void update_vertices_and_indices(float vertices[], int num_vertices, std::vector<unsigned int> indices,
//                                      int num_indices);
