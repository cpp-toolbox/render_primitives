 ...
 */
class DrawableIndexedVertexPositions {
  public:
    std::vector<glm::vec3> vertex_positions;
    std::vector<unsigned int> indices;
    DrawableIndexedVertexPositions(ShaderType shader_type, unsigned int draw_mode,
                                   std::vector<glm::vec3> vertex_positions, std::vector<unsigned int> indices,
