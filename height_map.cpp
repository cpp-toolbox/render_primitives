...
//
//    //    float vertex_positions[], int num_vertices, unsigned int indices[], int num_indices
...
//// void HeightMap::update_vertices_and_indices(float vertex_positions[], int num_vertices, std::vector<unsigned int>
